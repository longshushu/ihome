...
Revision ID: ce46c9d14aff
Revises: 
Create Date: 2018-10-06 20:22:56.421079
...
def upgrade():
    ...
    sa.Column('status', sa.Enum('WAIT_ACCEPT', 'WAIT_PAY', 'PAID', 'WAIT_COMMENT', 'COMPLETED', 'CANCELED', 'REJECTED'), nullable=True),
